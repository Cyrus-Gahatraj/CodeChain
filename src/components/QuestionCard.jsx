...
function QuestionCard({ id, userName, lang, question, likes, reviews }) {
  const shadowColor = colors[lang] || "#ffffff";

  return (
    <Link href={`/${userName}/${id}`}>
      <div
        className="p-6 rounded-2xl bg-[#0B0B09] text-white space-y-4 transition-all duration-300 hover:scale-[1.015] cursor-pointer"
      ...
      >
        ...
        <p className="text-base text-[#e0dfdc] italic mb-8 mr-1">
          "{question}"
        </p>
